...
def run_on_csv(uploaded_file):
    ...
    outfile_audio = "f3_mar3_111.csv"
    outfile_errors = "f4_mar3_111.csv"
...
st.title('🦜🔗 Vama AI Classify Chat Data')
